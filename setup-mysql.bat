@echo off
echo ========================================
echo Configuration MySQL pour votre binome
echo ========================================
...
echo.
echo 3. Configuration de la base de donnees MySQL...
echo Veuillez modifier le fichier .env avec vos parametres MySQL :
echo.
...
echo Assurez-vous que MySQL est demarre et que la base 'ecommerce' existe.
echo Si elle n'existe pas, créez-la avec : CREATE DATABASE ecommerce;
